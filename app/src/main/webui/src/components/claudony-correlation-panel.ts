...
import type { CommitmentRecord } from '../util/channel-adapter.js';

@customElement('claudony-correlation-panel')
export class ClaudonyCorrelationPanelElement extends LitElement {
...
declare global {
  interface HTMLElementTagNameMap {
    'claudony-correlation-panel': ClaudonyCorrelationPanelElement;
  }
}
