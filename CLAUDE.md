...
claudony.agent-pool.min-active=0        # pre-warm count (sessions kept active at all times)
claudony.agent-pool.max-active=10       # capacity ceiling (max concurrent active sessions)
