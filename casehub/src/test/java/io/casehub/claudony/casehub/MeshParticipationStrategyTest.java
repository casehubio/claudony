...
class MeshParticipationStrategyTest {
    ...
    void active_returnsActive() {
        Assertions.assertThat(new ActiveParticipationStrategy().strategyFor("worker-1", null))
                  .isEqualTo(MeshParticipationStrategy.MeshParticipation.ACTIVE);
    }

    @Test
    void reactive_returnsReactive() {
        Assertions.assertThat(new ReactiveParticipationStrategy().strategyFor("worker-1", null))
                  .isEqualTo(MeshParticipationStrategy.MeshParticipation.REACTIVE);
    }

    @Test
    void silent_returnsSilent() {
        Assertions.assertThat(new SilentParticipationStrategy().strategyFor("worker-1", null))
